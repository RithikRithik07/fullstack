...
export default function Home() {
  ...
  useEffect(() => {
    axios.get('https://fullstack-7xze.onrender.com/api/auth/me', { withCredentials: true })
      .then(r => setU(r.data.user))
      .catch(() => setU(null));
  }, []);

  const lg = async () => {
    await axios.post('https://fullstack-7xze.onrender.com/api/auth/logout', {}, { withCredentials: true });
    setU(null);
  };
